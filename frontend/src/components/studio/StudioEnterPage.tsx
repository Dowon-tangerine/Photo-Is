...
import tutorialPicture from "/imgs/tutorialBackImg.webp";
import landscapePicture from "/imgs/landScapeBackImg.webp";
...
function StudioEnterPage() {
    ...
    return (
        <div className="flex h-screen top-0 ">
            ...
            <div
                onClick={() => navigate("/modeModal")} // onClick에 arrow function을 사용하여 navigate 호출
            ...
            >
                <p className={StudioStyle.enterTitle}>Free Mode</p>
