        ...
        case 1:
            return (
                <div id="page-start" className='font-bookkGothic'>
                    ...
                    <img src="/imgs/렌즈.png" alt="렌즈의 단면도와 다양한 렌즈 종류" />
                    ...
                    <img src="/imgs/조리개.png" alt="조리개의 다양한 크기와 빛의 양 변화" />
        ...
        case 2:
            return (
                <div id="page-start"  className='font-bookkGothic'>
                    ...
                    <img src="/imgs/다게레오타입.png" alt="다게레오타입" />
                    ...
                    <img src="/imgs/카메라옵스큐라.png" alt="카메라 옵스큐라" />
                    ...
                    <img src="/imgs/조세프니엡스.png" alt="필름 카메라" />
                    ...
                    <img src="/imgs/빛의입사.png" alt="빛의입사" />
