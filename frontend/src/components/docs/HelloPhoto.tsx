    ...
    switch (currentPage) {
      ...
      case 2:
        return (
          ...
          <h2>2.4 사진의 종류</h2>
          <p>사진에는 다양한 종류가 있으며, 각기 다른 목적과 기능을 가지고 있습니다.</p>
    ...
    <div className={styles.container}>
      <div className={styles.sidebar}>
        ...
        <ol className='font-bookkGothic'>
          ...
          <button onClick={toggleSubMenu}>2. 사진이란?</button>
          {showSubMenu && (
            <>
              <button className={styles.subItem} onClick={() => setCurrentPage(2)}>2.1 사진술의 정의</button>
              <button className={styles.subItem} onClick={() => setCurrentPage(2)}>2.2 사진술의 역사적 배경</button>
              <button className={styles.subItem} onClick={() => setCurrentPage(2)}>2.3 사진의 과학적 특성</button>
              <button className={styles.subItem} onClick={() => setCurrentPage(2)}>2.3 사진의 종류</button>
            </>
          )}
          <button onClick={toggleSubMenu}>3. 사진 촬영 기초</button>
          {showSubMenu && (
            <>
              <button className={styles.subItem} onClick={() => setCurrentPage(3)}>3.1 잠상과 현상</button>
              <button className={styles.subItem} onClick={() => setCurrentPage(3)}>3.2 아날로그와 디지털 방식</button>
              <button className={styles.subItem} onClick={() => setCurrentPage(3)}>3.3 노출</button>
              <button className={styles.subItem} onClick={() => setCurrentPage(3)}>3.4 초점</button>
              <button className={styles.subItem} onClick={() => setCurrentPage(3)}>3.5 구도</button>
              <button className={styles.subItem} onClick={() => setCurrentPage(3)}>3.6 조명</button>
              <button className={styles.subItem} onClick={() => setCurrentPage(3)}>3.7 색온도</button>
